...
// ===== Settings =====
const WA_NUMBER = "12039478462"; // WhatsApp (203) 947-8462
const CALL_TEL  = "tel:+1-203-947-8462";
const GOOGLE_REVIEW = "https://g.page/r/CT-NYGVpAwezEAE/review";
...
function applyI18n(lang){
  ...
  // update links that depend on language
...
function setupBookingForm(){
  ...
  locBtn.addEventListener("click", ()=>{
    if(!navigator.geolocation){
      locEl.value = "Ubicación no disponible.";
      return;
    }
    ...
    navigator.geolocation.getCurrentPosition(
      (pos)=>{
        ...
        locEl.value = `https://maps.google.com/?q=${lat},${lng}`;
      },
      ()=>{
        locEl.value = "No se pudo obtener la ubicación.";
      },
  ...
  // Reviews button already in HTML, but keep link consistent:
  const revBtn = document.querySelector("[data-i18n='reviews_btn']")?.closest("a");
  if (revBtn) revBtn.href = GOOGLE_REVIEW;
}
